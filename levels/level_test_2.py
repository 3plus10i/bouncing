...
def level():
    ...
    ## 关卡基本信息
    level_info.level_name = '测试关 test2'
    level_info.level_description = '多球 中心引力场运动，环形障碍物'
    ...
    level_info.v_0 = []
    for i in range(3):
        level_info.pos_0.append(np.array([level_info.rect_w / 2, level_info.rect_h / 8]))  # 质点位置初值
        va_0 = i * np.pi / 3  # 质点速度方向初值(rad)
        vm_0 = 2  # 质点速度大小初值
